...
import { CreateHoursOfOperationRequest, CreateHoursOfOperationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, CreateHoursOfOperationCommand } from "../../client-connect/mod.ts";
