...
import { SendWorkflowStepStateRequest, SendWorkflowStepStateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TransferClient, SendWorkflowStepStateCommand } from "../../client-transfer/mod.ts";
