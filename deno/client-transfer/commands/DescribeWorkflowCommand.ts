...
import { DescribeWorkflowRequest, DescribeWorkflowResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TransferClient, DescribeWorkflowCommand } from "../../client-transfer/mod.ts";
