...
import { CreateAppInstanceUserRequest, CreateAppInstanceUserResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKIdentityClient, CreateAppInstanceUserCommand } from "../../client-chime-sdk-identity/mod.ts";
