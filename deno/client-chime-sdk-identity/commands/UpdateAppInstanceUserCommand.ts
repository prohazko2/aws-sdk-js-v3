...
import { UpdateAppInstanceUserRequest, UpdateAppInstanceUserResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKIdentityClient, UpdateAppInstanceUserCommand } from "../../client-chime-sdk-identity/mod.ts";
