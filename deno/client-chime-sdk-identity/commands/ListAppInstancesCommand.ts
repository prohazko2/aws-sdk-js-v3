...
import { ListAppInstancesRequest, ListAppInstancesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKIdentityClient, ListAppInstancesCommand } from "../../client-chime-sdk-identity/mod.ts";
