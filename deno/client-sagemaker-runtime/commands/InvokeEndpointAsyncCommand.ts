...
import { InvokeEndpointAsyncInput, InvokeEndpointAsyncOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerRuntimeClient, InvokeEndpointAsyncCommand } from "../../client-sagemaker-runtime/mod.ts";
