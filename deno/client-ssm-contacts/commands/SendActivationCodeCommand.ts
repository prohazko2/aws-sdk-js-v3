...
import { SendActivationCodeRequest, SendActivationCodeResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, SendActivationCodeCommand } from "../../client-ssm-contacts/mod.ts";
