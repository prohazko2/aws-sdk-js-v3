...
import { UpdateProjectVisibilityInput, UpdateProjectVisibilityOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, UpdateProjectVisibilityCommand } from "../../client-codebuild/mod.ts";
