...
import { DescribeCustomKeyStoresRequest, DescribeCustomKeyStoresResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KMSClient, DescribeCustomKeyStoresCommand } from "../../client-kms/mod.ts";
