...
import { CreateKeyRequest, CreateKeyResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1CreateKeyCommand, serializeAws_json1_1CreateKeyCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { KMSClient, CreateKeyCommand } from "../../client-kms/mod.ts";
