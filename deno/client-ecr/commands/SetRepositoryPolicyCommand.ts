...
import { SetRepositoryPolicyRequest, SetRepositoryPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECRClient, SetRepositoryPolicyCommand } from "../../client-ecr/mod.ts";
