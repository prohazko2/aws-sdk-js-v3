...
import { ListManagedDataIdentifiersRequest, ListManagedDataIdentifiersResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, ListManagedDataIdentifiersCommand } from "../../client-macie2/mod.ts";
