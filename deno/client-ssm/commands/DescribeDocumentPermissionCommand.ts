...
import { DescribeDocumentPermissionRequest, DescribeDocumentPermissionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, DescribeDocumentPermissionCommand } from "../../client-ssm/mod.ts";
