...
import { GetInventoryResult } from "../models/models_1.ts";
import { GetInventoryRequest } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, GetInventoryCommand } from "../../client-ssm/mod.ts";
