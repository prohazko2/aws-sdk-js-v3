...
import { AddTagsToResourceRequest, AddTagsToResourceResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, AddTagsToResourceCommand } from "../../client-directory-service/mod.ts";
