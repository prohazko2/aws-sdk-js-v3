...
import { CreateLocationS3Request, CreateLocationS3Response } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataSyncClient, CreateLocationS3Command } from "../../client-datasync/mod.ts";
