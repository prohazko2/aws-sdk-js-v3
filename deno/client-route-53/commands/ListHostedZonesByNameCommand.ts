...
import { ListHostedZonesByNameRequest, ListHostedZonesByNameResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, ListHostedZonesByNameCommand } from "../../client-route-53/mod.ts";
