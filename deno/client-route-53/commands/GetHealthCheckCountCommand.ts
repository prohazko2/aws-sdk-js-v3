...
import { GetHealthCheckCountRequest, GetHealthCheckCountResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, GetHealthCheckCountCommand } from "../../client-route-53/mod.ts";
