...
import { DescribeCustomPluginRequest, DescribeCustomPluginResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaConnectClient, DescribeCustomPluginCommand } from "../../client-kafkaconnect/mod.ts";
