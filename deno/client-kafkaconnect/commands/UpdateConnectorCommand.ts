...
import { UpdateConnectorRequest, UpdateConnectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaConnectClient, UpdateConnectorCommand } from "../../client-kafkaconnect/mod.ts";
