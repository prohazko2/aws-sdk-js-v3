...
import { DescribeConnectorRequest, DescribeConnectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaConnectClient, DescribeConnectorCommand } from "../../client-kafkaconnect/mod.ts";
