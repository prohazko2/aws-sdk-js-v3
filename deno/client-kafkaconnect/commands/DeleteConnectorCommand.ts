...
import { DeleteConnectorRequest, DeleteConnectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaConnectClient, DeleteConnectorCommand } from "../../client-kafkaconnect/mod.ts";
