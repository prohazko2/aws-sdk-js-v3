...
import { ListConnectorsRequest, ListConnectorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaConnectClient, ListConnectorsCommand } from "../../client-kafkaconnect/mod.ts";
