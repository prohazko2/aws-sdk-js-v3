...
import { ListResolverEndpointsRequest, ListResolverEndpointsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, ListResolverEndpointsCommand } from "../../client-route53resolver/mod.ts";
