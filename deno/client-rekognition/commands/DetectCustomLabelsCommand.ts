...
import { DetectCustomLabelsRequest, DetectCustomLabelsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, DetectCustomLabelsCommand } from "../../client-rekognition/mod.ts";
