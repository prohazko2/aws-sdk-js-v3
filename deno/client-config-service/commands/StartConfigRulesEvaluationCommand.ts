...
import { StartConfigRulesEvaluationRequest, StartConfigRulesEvaluationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, StartConfigRulesEvaluationCommand } from "../../client-config-service/mod.ts";
