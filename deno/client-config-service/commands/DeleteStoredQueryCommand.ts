...
import { DeleteStoredQueryRequest, DeleteStoredQueryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, DeleteStoredQueryCommand } from "../../client-config-service/mod.ts";
