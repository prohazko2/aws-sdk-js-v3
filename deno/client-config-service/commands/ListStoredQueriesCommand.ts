...
import { ListStoredQueriesRequest, ListStoredQueriesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, ListStoredQueriesCommand } from "../../client-config-service/mod.ts";
