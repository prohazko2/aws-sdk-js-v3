...
import { GetAutoTerminationPolicyInput, GetAutoTerminationPolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRClient, GetAutoTerminationPolicyCommand } from "../../client-emr/mod.ts";
