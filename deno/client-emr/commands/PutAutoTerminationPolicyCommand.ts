...
import { PutAutoTerminationPolicyInput, PutAutoTerminationPolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRClient, PutAutoTerminationPolicyCommand } from "../../client-emr/mod.ts";
