...
import { CreateResourceShareRequest, CreateResourceShareResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RAMClient, CreateResourceShareCommand } from "../../client-ram/mod.ts";
