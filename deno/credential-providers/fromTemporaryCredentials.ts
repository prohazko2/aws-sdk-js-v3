import { AssumeRoleCommand, AssumeRoleCommandInput, STSClient, STSClientConfig } from "../client-sts/mod.ts";
 ...
 *
 * ```javascript
 * import { fromTemporaryCredentials } from "../credential-providers/mod.ts";
