import { getDefaultRoleAssumer, getDefaultRoleAssumerWithWebIdentity, STSClientConfig } from "../client-sts/mod.ts";
import { fromIni as _fromIni, FromIniInit as _FromIniInit } from "../credential-provider-ini/mod.ts";
 ...
 *
 * ```javascript
 * import { fromIni } from "../credential-providers/mod.ts";
