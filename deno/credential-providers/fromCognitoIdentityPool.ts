import { CognitoIdentityClient, CognitoIdentityClientConfig } from "../client-cognito-identity/mod.ts";
import {
...
} from "../credential-provider-cognito-identity/mod.ts";
 ...
 *
 * ```javascript
 * import { fromCognitoIdentityPool } from "../credential-providers/mod.ts";
