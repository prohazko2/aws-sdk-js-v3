import { fromProcess as _fromProcess, FromProcessInit as _FromProcessInit } from "../credential-provider-process/mod.ts";
 ...
 *
 * ```javascript
 * import { fromProcess } from "../credential-providers/mod.ts";
