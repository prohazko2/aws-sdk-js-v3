import { SSOClient, SSOClientConfig } from "../client-sso/mod.ts";
import { fromSSO as _fromSSO, FromSSOInit as _FromSSOInit } from "../credential-provider-sso/mod.ts";
 ...
 *
 * ```javascript
 * import { fromSSO } from "../credential-providers/mod.ts";
