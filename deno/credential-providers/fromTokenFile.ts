import { getDefaultRoleAssumerWithWebIdentity, STSClientConfig } from "../client-sts/mod.ts";
import {
  fromTokenFile as _fromTokenFile,
  FromTokenFileInit as _FromTokenFileInit,
} from "../credential-provider-web-identity/mod.ts";
 ...
 *
 * ```javascript
 * import { fromTokenFile } from "../credential-providers/mod.ts";
