...
import { CreateChannelBanRequest, CreateChannelBanResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKMessagingClient, CreateChannelBanCommand } from "../../client-chime-sdk-messaging/mod.ts";
