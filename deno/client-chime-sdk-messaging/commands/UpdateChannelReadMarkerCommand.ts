...
import { UpdateChannelReadMarkerRequest, UpdateChannelReadMarkerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKMessagingClient, UpdateChannelReadMarkerCommand } from "../../client-chime-sdk-messaging/mod.ts";
