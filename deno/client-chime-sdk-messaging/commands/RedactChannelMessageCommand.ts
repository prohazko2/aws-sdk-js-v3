...
import { RedactChannelMessageRequest, RedactChannelMessageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeSDKMessagingClient, RedactChannelMessageCommand } from "../../client-chime-sdk-messaging/mod.ts";
