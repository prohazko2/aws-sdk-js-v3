...
import { CreateStorageVirtualMachineRequest, CreateStorageVirtualMachineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, CreateStorageVirtualMachineCommand } from "../../client-fsx/mod.ts";
