...
import { CreateVolumeFromBackupRequest, CreateVolumeFromBackupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, CreateVolumeFromBackupCommand } from "../../client-fsx/mod.ts";
