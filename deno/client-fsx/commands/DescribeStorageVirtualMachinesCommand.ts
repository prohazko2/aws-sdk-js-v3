...
import { DescribeStorageVirtualMachinesRequest, DescribeStorageVirtualMachinesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, DescribeStorageVirtualMachinesCommand } from "../../client-fsx/mod.ts";
