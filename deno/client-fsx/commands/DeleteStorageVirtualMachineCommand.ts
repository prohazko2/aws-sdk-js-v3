...
import { DeleteStorageVirtualMachineRequest, DeleteStorageVirtualMachineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, DeleteStorageVirtualMachineCommand } from "../../client-fsx/mod.ts";
