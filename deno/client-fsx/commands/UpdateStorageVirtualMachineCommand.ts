...
import { UpdateStorageVirtualMachineRequest, UpdateStorageVirtualMachineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, UpdateStorageVirtualMachineCommand } from "../../client-fsx/mod.ts";
