...
import { DeleteMultiRegionAccessPointRequest, DeleteMultiRegionAccessPointResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, DeleteMultiRegionAccessPointCommand } from "../../client-s3-control/mod.ts";
