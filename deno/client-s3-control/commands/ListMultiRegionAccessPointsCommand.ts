...
import { ListMultiRegionAccessPointsRequest, ListMultiRegionAccessPointsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, ListMultiRegionAccessPointsCommand } from "../../client-s3-control/mod.ts";
