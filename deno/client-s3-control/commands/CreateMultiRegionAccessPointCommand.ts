...
import { CreateMultiRegionAccessPointRequest, CreateMultiRegionAccessPointResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, CreateMultiRegionAccessPointCommand } from "../../client-s3-control/mod.ts";
