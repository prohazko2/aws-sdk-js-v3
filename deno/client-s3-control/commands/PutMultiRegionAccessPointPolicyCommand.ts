...
import { PutMultiRegionAccessPointPolicyRequest, PutMultiRegionAccessPointPolicyResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, PutMultiRegionAccessPointPolicyCommand } from "../../client-s3-control/mod.ts";
