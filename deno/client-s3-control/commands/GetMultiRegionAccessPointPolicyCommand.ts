...
import { GetMultiRegionAccessPointPolicyRequest, GetMultiRegionAccessPointPolicyResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, GetMultiRegionAccessPointPolicyCommand } from "../../client-s3-control/mod.ts";
