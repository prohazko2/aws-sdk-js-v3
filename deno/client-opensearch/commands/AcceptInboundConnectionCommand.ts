...
import { AcceptInboundConnectionRequest, AcceptInboundConnectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpenSearchClient, AcceptInboundConnectionCommand } from "../../client-opensearch/mod.ts";
