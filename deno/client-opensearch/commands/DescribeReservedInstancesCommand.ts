...
import { DescribeReservedInstancesRequest, DescribeReservedInstancesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpenSearchClient, DescribeReservedInstancesCommand } from "../../client-opensearch/mod.ts";
