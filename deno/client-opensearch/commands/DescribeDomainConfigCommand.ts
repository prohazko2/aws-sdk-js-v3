...
import { DescribeDomainConfigRequest, DescribeDomainConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpenSearchClient, DescribeDomainConfigCommand } from "../../client-opensearch/mod.ts";
