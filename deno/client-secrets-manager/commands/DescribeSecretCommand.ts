...
import { DescribeSecretRequest, DescribeSecretResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SecretsManagerClient, DescribeSecretCommand } from "../../client-secrets-manager/mod.ts";
