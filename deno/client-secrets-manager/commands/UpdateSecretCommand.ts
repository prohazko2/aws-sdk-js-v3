...
import { UpdateSecretRequest, UpdateSecretResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SecretsManagerClient, UpdateSecretCommand } from "../../client-secrets-manager/mod.ts";
