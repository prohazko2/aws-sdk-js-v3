...
import { AssociateTrunkInterfaceRequest, AssociateTrunkInterfaceResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AssociateTrunkInterfaceCommand } from "../../client-ec2/mod.ts";
