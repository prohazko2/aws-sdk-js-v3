...
import { ImportVolumeRequest, ImportVolumeResult } from "../models/models_4.ts";
import { deserializeAws_ec2ImportVolumeCommand, serializeAws_ec2ImportVolumeCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, ImportVolumeCommand } from "../../client-ec2/mod.ts";
