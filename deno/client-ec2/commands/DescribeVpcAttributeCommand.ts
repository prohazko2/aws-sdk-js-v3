...
import { DescribeVpcAttributeRequest, DescribeVpcAttributeResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeVpcAttributeCommand } from "../../client-ec2/mod.ts";
