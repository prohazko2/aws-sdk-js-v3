...
import { CreateStoreImageTaskRequest, CreateStoreImageTaskResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateStoreImageTaskCommand } from "../../client-ec2/mod.ts";
