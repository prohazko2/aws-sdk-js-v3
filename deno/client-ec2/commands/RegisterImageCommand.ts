...
import { RegisterImageRequest, RegisterImageResult } from "../models/models_5.ts";
import { deserializeAws_ec2RegisterImageCommand, serializeAws_ec2RegisterImageCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, RegisterImageCommand } from "../../client-ec2/mod.ts";
