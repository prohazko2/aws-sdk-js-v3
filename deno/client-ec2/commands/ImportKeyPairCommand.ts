...
import { ImportKeyPairRequest, ImportKeyPairResult } from "../models/models_4.ts";
import { deserializeAws_ec2ImportKeyPairCommand, serializeAws_ec2ImportKeyPairCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, ImportKeyPairCommand } from "../../client-ec2/mod.ts";
