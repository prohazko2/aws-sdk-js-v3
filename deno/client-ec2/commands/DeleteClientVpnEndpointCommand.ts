...
import { DeleteClientVpnEndpointRequest, DeleteClientVpnEndpointResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteClientVpnEndpointCommand } from "../../client-ec2/mod.ts";
