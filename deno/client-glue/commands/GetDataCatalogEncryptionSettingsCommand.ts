...
import { GetDataCatalogEncryptionSettingsRequest, GetDataCatalogEncryptionSettingsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, GetDataCatalogEncryptionSettingsCommand } from "../../client-glue/mod.ts";
