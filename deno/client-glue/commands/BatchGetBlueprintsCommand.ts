...
import { BatchGetBlueprintsRequest, BatchGetBlueprintsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, BatchGetBlueprintsCommand } from "../../client-glue/mod.ts";
