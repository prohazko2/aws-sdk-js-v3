...
import { GetDatabaseRequest } from "../models/models_0.ts";
import { GetDatabaseResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, GetDatabaseCommand } from "../../client-glue/mod.ts";
