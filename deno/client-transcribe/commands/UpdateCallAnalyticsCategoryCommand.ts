...
import { UpdateCallAnalyticsCategoryRequest, UpdateCallAnalyticsCategoryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranscribeClient, UpdateCallAnalyticsCategoryCommand } from "../../client-transcribe/mod.ts";
