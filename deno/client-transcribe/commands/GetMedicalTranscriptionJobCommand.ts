...
import { GetMedicalTranscriptionJobRequest, GetMedicalTranscriptionJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranscribeClient, GetMedicalTranscriptionJobCommand } from "../../client-transcribe/mod.ts";
