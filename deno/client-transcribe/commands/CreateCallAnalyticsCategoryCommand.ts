...
import { CreateCallAnalyticsCategoryRequest, CreateCallAnalyticsCategoryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranscribeClient, CreateCallAnalyticsCategoryCommand } from "../../client-transcribe/mod.ts";
