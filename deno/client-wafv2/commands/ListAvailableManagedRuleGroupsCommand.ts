...
import { ListAvailableManagedRuleGroupsRequest, ListAvailableManagedRuleGroupsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFV2Client, ListAvailableManagedRuleGroupsCommand } from "../../client-wafv2/mod.ts";
