...
import { GetCoreDeviceRequest, GetCoreDeviceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GreengrassV2Client, GetCoreDeviceCommand } from "../../client-greengrassv2/mod.ts";
