...
import { ResolveComponentCandidatesRequest, ResolveComponentCandidatesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GreengrassV2Client, ResolveComponentCandidatesCommand } from "../../client-greengrassv2/mod.ts";
