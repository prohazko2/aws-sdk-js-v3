...
import { CreateComponentVersionRequest, CreateComponentVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GreengrassV2Client, CreateComponentVersionCommand } from "../../client-greengrassv2/mod.ts";
