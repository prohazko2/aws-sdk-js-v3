...
import { CreateInAppTemplateRequest, CreateInAppTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, CreateInAppTemplateCommand } from "../../client-pinpoint/mod.ts";
