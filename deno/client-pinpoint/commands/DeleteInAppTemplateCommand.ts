...
import { DeleteInAppTemplateRequest, DeleteInAppTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, DeleteInAppTemplateCommand } from "../../client-pinpoint/mod.ts";
