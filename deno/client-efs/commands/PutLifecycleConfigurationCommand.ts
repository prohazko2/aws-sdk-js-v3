...
import { LifecycleConfigurationDescription, PutLifecycleConfigurationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EFSClient, PutLifecycleConfigurationCommand } from "../../client-efs/mod.ts";
