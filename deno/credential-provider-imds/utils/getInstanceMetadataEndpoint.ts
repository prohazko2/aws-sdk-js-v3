...
import { Endpoint as InstanceMetadataEndpoint } from "../config/Endpoint.ts";
import { CONFIG_ENDPOINT_NAME, ENDPOINT_CONFIG_OPTIONS, ENV_ENDPOINT_NAME } from "../config/EndpointConfigOptions.ts";
import { EndpointMode } from "../config/EndpointMode.ts";
import {
  CONFIG_ENDPOINT_MODE_NAME,
  ENDPOINT_MODE_CONFIG_OPTIONS,
  ENV_ENDPOINT_MODE_NAME,
} from "../config/EndpointModeConfigOptions.ts";
