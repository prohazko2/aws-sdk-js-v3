...
import { DescribeTaskInput, DescribeTaskOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SnowDeviceManagementClient, DescribeTaskCommand } from "../../client-snow-device-management/mod.ts";
