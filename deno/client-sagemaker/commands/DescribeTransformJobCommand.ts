...
import { DescribeTransformJobRequest, DescribeTransformJobResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeTransformJobCommand } from "../../client-sagemaker/mod.ts";
