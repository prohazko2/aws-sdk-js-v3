...
import { ListStudioLifecycleConfigsRequest, ListStudioLifecycleConfigsResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListStudioLifecycleConfigsCommand } from "../../client-sagemaker/mod.ts";
