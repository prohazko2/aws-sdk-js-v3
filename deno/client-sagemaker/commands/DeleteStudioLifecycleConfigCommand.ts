...
import { DeleteStudioLifecycleConfigRequest } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DeleteStudioLifecycleConfigCommand } from "../../client-sagemaker/mod.ts";
