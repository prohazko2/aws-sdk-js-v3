...
import { DescribeSnapshotCopyGrantsMessage, SnapshotCopyGrantMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, DescribeSnapshotCopyGrantsCommand } from "../../client-redshift/mod.ts";
