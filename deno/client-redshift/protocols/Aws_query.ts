...
} from "../commands/AssociateDataShareConsumerCommand.ts";
import {
...
import { AuthorizeDataShareCommandInput, AuthorizeDataShareCommandOutput } from "../commands/AuthorizeDataShareCommand.ts";
import {
...
} from "../commands/DeauthorizeDataShareCommand.ts";
import {
...
import { DescribeDataSharesCommandInput, DescribeDataSharesCommandOutput } from "../commands/DescribeDataSharesCommand.ts";
import {
  DescribeDataSharesForConsumerCommandInput,
  DescribeDataSharesForConsumerCommandOutput,
} from "../commands/DescribeDataSharesForConsumerCommand.ts";
import {
  DescribeDataSharesForProducerCommandInput,
  DescribeDataSharesForProducerCommandOutput,
} from "../commands/DescribeDataSharesForProducerCommand.ts";
import {
...
} from "../commands/DisassociateDataShareConsumerCommand.ts";
...
import { RejectDataShareCommandInput, RejectDataShareCommandOutput } from "../commands/RejectDataShareCommand.ts";
import {
  ...
  collectBodyString(streamBody, context).then((encoded) => {
    if (encoded.length) {
      const parsedObj = xmlParse(encoded, {
        ...
        trimValues: false,
        tagValueProcessor: (val: string) => (val.trim() === "" && val.includes("\n") ? "" : decodeHTML(val)),
      });
