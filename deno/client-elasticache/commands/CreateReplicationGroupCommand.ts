...
import { CreateReplicationGroupMessage, CreateReplicationGroupResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElastiCacheClient, CreateReplicationGroupCommand } from "../../client-elasticache/mod.ts";
