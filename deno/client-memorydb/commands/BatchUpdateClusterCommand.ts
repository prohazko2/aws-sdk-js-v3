...
import { BatchUpdateClusterRequest, BatchUpdateClusterResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MemoryDBClient, BatchUpdateClusterCommand } from "../../client-memorydb/mod.ts";
