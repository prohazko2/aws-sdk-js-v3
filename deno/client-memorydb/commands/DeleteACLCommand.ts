...
import { DeleteACLRequest, DeleteACLResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1DeleteACLCommand, serializeAws_json1_1DeleteACLCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { MemoryDBClient, DeleteACLCommand } from "../../client-memorydb/mod.ts";
