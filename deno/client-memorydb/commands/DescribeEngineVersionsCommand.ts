...
import { DescribeEngineVersionsRequest, DescribeEngineVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MemoryDBClient, DescribeEngineVersionsCommand } from "../../client-memorydb/mod.ts";
