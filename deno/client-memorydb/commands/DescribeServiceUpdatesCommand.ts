...
import { DescribeServiceUpdatesRequest, DescribeServiceUpdatesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MemoryDBClient, DescribeServiceUpdatesCommand } from "../../client-memorydb/mod.ts";
