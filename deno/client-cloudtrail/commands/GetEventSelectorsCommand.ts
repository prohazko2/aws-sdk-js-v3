...
import { GetEventSelectorsRequest, GetEventSelectorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudTrailClient, GetEventSelectorsCommand } from "../../client-cloudtrail/mod.ts";
