...
} from "./commands/DeleteEntityTypeCommand.ts";
...
} from "./commands/DeleteEventTypeCommand.ts";
import {
...
import { DeleteLabelCommand, DeleteLabelCommandInput, DeleteLabelCommandOutput } from "./commands/DeleteLabelCommand.ts";
...
} from "./commands/DeleteModelVersionCommand.ts";
import {
  DeleteOutcomeCommand,
  DeleteOutcomeCommandInput,
  DeleteOutcomeCommandOutput,
} from "./commands/DeleteOutcomeCommand.ts";
...
} from "./commands/DeleteVariableCommand.ts";
import {
