...
import { CreateIAMPolicyAssignmentRequest, CreateIAMPolicyAssignmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, CreateIAMPolicyAssignmentCommand } from "../../client-quicksight/mod.ts";
