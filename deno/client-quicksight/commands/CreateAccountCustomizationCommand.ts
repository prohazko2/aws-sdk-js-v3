...
import { CreateAccountCustomizationRequest, CreateAccountCustomizationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, CreateAccountCustomizationCommand } from "../../client-quicksight/mod.ts";
