...
import { GetDashboardEmbedUrlRequest, GetDashboardEmbedUrlResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, GetDashboardEmbedUrlCommand } from "../../client-quicksight/mod.ts";
