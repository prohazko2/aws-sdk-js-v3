...
import { CreateScheduledAuditRequest, CreateScheduledAuditResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, CreateScheduledAuditCommand } from "../../client-iot/mod.ts";
