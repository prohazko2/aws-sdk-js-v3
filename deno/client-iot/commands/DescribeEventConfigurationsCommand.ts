...
import { DescribeEventConfigurationsRequest, DescribeEventConfigurationsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, DescribeEventConfigurationsCommand } from "../../client-iot/mod.ts";
