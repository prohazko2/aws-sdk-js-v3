...
import { DescribeFleetMetricRequest, DescribeFleetMetricResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, DescribeFleetMetricCommand } from "../../client-iot/mod.ts";
