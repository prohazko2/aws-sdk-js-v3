...
import { RegisterCertificateRequest, RegisterCertificateResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, RegisterCertificateCommand } from "../../client-iot/mod.ts";
