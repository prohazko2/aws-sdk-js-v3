...
import { TestInvokeAuthorizerRequest, TestInvokeAuthorizerResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, TestInvokeAuthorizerCommand } from "../../client-iot/mod.ts";
