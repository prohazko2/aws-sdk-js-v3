...
import { UpdateIndexingConfigurationRequest, UpdateIndexingConfigurationResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, UpdateIndexingConfigurationCommand } from "../../client-iot/mod.ts";
