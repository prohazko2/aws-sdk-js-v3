...
import { UpdateProvisioningTemplateRequest, UpdateProvisioningTemplateResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, UpdateProvisioningTemplateCommand } from "../../client-iot/mod.ts";
