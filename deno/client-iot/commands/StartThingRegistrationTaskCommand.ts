...
import { StartThingRegistrationTaskRequest, StartThingRegistrationTaskResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, StartThingRegistrationTaskCommand } from "../../client-iot/mod.ts";
