...
import { GetBucketsAggregationRequest, GetBucketsAggregationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, GetBucketsAggregationCommand } from "../../client-iot/mod.ts";
