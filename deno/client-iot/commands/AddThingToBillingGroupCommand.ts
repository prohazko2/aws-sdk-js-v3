...
import { AddThingToBillingGroupRequest, AddThingToBillingGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, AddThingToBillingGroupCommand } from "../../client-iot/mod.ts";
