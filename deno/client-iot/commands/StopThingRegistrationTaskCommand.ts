...
import { StopThingRegistrationTaskRequest, StopThingRegistrationTaskResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, StopThingRegistrationTaskCommand } from "../../client-iot/mod.ts";
