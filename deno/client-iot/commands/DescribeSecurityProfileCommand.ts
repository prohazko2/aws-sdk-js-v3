...
import { DescribeSecurityProfileRequest, DescribeSecurityProfileResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, DescribeSecurityProfileCommand } from "../../client-iot/mod.ts";
