...
import { RegisterCACertificateRequest, RegisterCACertificateResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, RegisterCACertificateCommand } from "../../client-iot/mod.ts";
