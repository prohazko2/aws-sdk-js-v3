...
import { ListRetainedMessagesRequest, ListRetainedMessagesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTDataPlaneClient, ListRetainedMessagesCommand } from "../../client-iot-data-plane/mod.ts";
