...
import { GetRetainedMessageRequest, GetRetainedMessageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTDataPlaneClient, GetRetainedMessageCommand } from "../../client-iot-data-plane/mod.ts";
